...
export const REPORT_PAGES: PageData[] = [
      ...
      chart: {
        ...
        data: [
          { 
            ...
            expandedContent: {
              ...
              bullets: [
                ...
                '高门槛：AIC (自动化集成工业) 玩法构筑了极高的认知壁垒，一旦学会，玩家很难回流到传统RPG。',
                '长尾效应：UGC 蓝图分享机制将带来类似Minecraft的超长生命周期。'
              ],
              dataPoints: [
          ...
          { 
            ...
            iconName: 'TrendingUp',
            details: '从单一 CP 向平台型公司重估，目标估值 468亿。',
            color: '#f59e0b',
            expandedContent: {
              title: '估值逻辑：SOTP 分部加总',
              description: '考虑到《终末地》具备的平台化特征（UGC 蓝图分享、多端互通），我们认为其应享受科技平台型公司的估值溢价，而非传统游戏公司的10-15倍市盈率。',
              bullets: [
                '存量业务：明日方舟2D本传提供稳定的15亿+年净利，作为现金奶牛。',
                '增量业务：终末地2026年预计贡献23.4亿净利，给予20倍市盈率。',
                '对比案例：参照EA私有化交易(12.8倍 EBITDA)及Shift Up上市表现。'
              ],
              dataPoints: [
                { label: '2026E 净利', value: '23.4亿' },
                { label: '目标 P/E', value: '20x' },
                { label: '目标市值', value: '468亿' }
              ]
            }
          }
        ]
  ...
  // 第 13 页：投资逻辑三 (Investment Thesis 3)
  {
    ...
    content: {
      ...
      bullets: [
        '**UGC 平台化**: 引入蓝图分享系统，将游戏从单纯的Content Provider转型为Platform。玩家自主生产内容（产线设计），极大地降低了长线运营的各种成本。同时搭建好蓝图的玩家又会积极的投身到分享当中，从而完成好内容的正向循环。如同明日方舟的b站教程一样，创造非常积极的玩家生态。',
  ...
  // 第 14 页：财务模型 (Financials)
  {
    ...
    content: {
      ...
      bullets: [
        '**保守基石**: 我们将存量业务（明日方舟）的预期下调至 **20亿 RMB**，确认其作为现金奶牛而非增长引擎的定位，为新业务提供容错空间。',
        '**理性增长**: 对于《终末地》，我们将中性预期设定为 **20亿 RMB**。这并非看衰，而是基于二次元游戏赛道整体退火的现实情况，以及源自AIC玩法的高门槛筛选机制——我们不指望它成为大众化的《原神》，但确信它能垄断高净值的“工业党”用户。',
        '**安全边际**: 尽管库洛游戏的交易对价大约 **4x P/S（预测）**，我们仍坚持 **3x P/S** 的定价。这 1.0x 的折价是对当前行业负β的充分避险。**120亿**不是一个激进的赌注，而是一个在红海中寻找确定性的**防御性报价**'
      ],
      chart: {
        ...
        highlight: '尽管竞品对标 4x，我们坚持 **3倍 P/S** 的保守定价，锁定 **120亿 RMB** 的安全边际。'
      },
